...
for muni_id, name in [(1, "本巣市"), (2, "白川村"), (3, "飛騨市"), (4, "高山市"), (5, "郡上市")]:
    ...
    print(f"{name:6s} 寄付金額={kpi.revenue:>14,} 件数={kpi.orders:>8,} 謝礼品価格={kpi.total_cost:>14,} 返礼率={kpi.expense_ratio*100:.1f}%")
...
print(f"  寄付金額={kpi.revenue:,} / 件数={kpi.orders:,} / 謝礼品価格={kpi.total_cost:,} / 返礼率={kpi.expense_ratio*100:.1f}%")
